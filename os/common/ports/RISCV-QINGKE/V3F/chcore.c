...
/*===========================================================================*/
extern __attribute__((always_inline)) inline void save_context(void);
...
extern __attribute__((always_inline)) inline void recover_context(void);
...
extern __attribute__((always_inline)) inline void save_context_irq(void);
...
extern __attribute__((always_inline)) inline void recover_context_irq(void);
...
extern __attribute__((always_inline)) inline void _port_irq_prologue(void);
__attribute__((always_inline)) inline void _port_irq_prologue(void)
{
    save_context_irq();
}

extern __attribute__((always_inline)) inline void _port_irq_epilogue(void);
