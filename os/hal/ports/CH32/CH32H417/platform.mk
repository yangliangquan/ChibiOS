...
EXIST_SOURCES := $(shell find $(abspath $(dir $(lastword $(MAKEFILE_LIST)))../LLD) -name "*.c")
LLD_SOURCES := $(shell find $(abspath $(dir $(lastword $(MAKEFILE_LIST)))) -name "*.c")
PLATFORMSRC += ${EXIST_SOURCES} ${LLD_SOURCES}
PLATFORMINC := $(abspath $(dir $(lastword $(MAKEFILE_LIST)))) $(shell find $(abspath $(dir $(lastword $(MAKEFILE_LIST)))../LLD/) -type d)
