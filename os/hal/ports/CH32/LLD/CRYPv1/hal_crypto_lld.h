 ...
 * @brief   CH32 cryptographic subsystem low level driver header.
 *
 * @addtogroup CRYPTO
 * @{
 */
 ...
 */
#if !defined(CH32_CRY_USE_CRY1) || defined(__DOXYGEN__)
#define CH32_CRY_USE_CRY1                  FALSE
#endif
/** @} */
...
#if (CH32_CRY_USE_CRY1 == TRUE) && !defined(__DOXYGEN__)
