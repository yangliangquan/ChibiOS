...
/**
 * @file    hal_mac_lld.h
 * @brief   CH32 MAC subsystem low level driver header.
 *
 * @addtogroup MAC
 * @{
 */
 ...
 */
#if !defined(CH32_MAC_USE_MAC1) || defined(__DOXYGEN__)
#define CH32_MAC_USE_MAC1               FALSE
#endif
/** @} */
...
#if (CH32_MAC_USE_MAC1 == TRUE) && !defined(__DOXYGEN__)
