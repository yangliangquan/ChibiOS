...
/**
 * @file    hal_efl_lld.h
 * @brief   CH32 Embedded Flash subsystem low level driver header.
 *
 * @addtogroup HAL_EFL
 * @{
 */
 ...
 */
#if !defined(CH32_EFL_USE_EFL1) || defined(__DOXYGEN__)
#define CH32_EFL_USE_EFL1               FALSE
#endif
/** @} */
...
#if (CH32_EFL_USE_EFL1 == TRUE) && !defined(__DOXYGEN__)
