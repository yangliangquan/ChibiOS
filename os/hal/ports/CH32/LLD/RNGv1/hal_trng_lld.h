...
/**
 * @file    hal_trng_lld.h
 * @brief   CH32 TRNG subsystem low level driver header.
 *
 * @addtogroup TRNG
 * @{
 */
 ...
 */
#if !defined(CH32_TRNG_USE_TRNG1) || defined(__DOXYGEN__)
#define CH32_TRNG_USE_TRNG1               FALSE
#endif
/** @} */
...
#if (CH32_TRNG_USE_TRNG1 == TRUE) && !defined(__DOXYGEN__)
