...
/**
 * @file    hal_usb_lld.h
 * @brief   CH32H417 USBFS (OTGv1) USB subsystem low level driver header.
 *
 * @addtogroup USB
 * @{
 */
 ...
 */
/**
 * @brief   USBFS (OTGv1) driver enable switch.
 * @details If set to @p TRUE the support for USBFS is included.
 * @note    The default is @p FALSE.
 */
#if !defined(CH32_OTG_USE_USB1) || defined(__DOXYGEN__)
#define CH32_OTG_USE_USB1                  FALSE
#endif
/** @} */
 ...
 * @notapi
 */
#define usb_lld_get_frame_number(usbp) ((uint16_t)0)
 ...
 * @api
 */
#define usb_lld_connect_bus(usbp) do { (void)usbp; } while (false)
 ...
 * @api
 */
#define usb_lld_disconnect_bus(usbp) do { (void)usbp; } while (false)
 ...
 * @notapi
 */
#define usb_lld_wakeup_host(usbp) do { (void)usbp; } while (false)
